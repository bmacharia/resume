...
function App() {
  ...
  return (
    <div className={`max-w-5xl mx-auto my-8 mb-12 bg-white rounded-md
      ...
      text-[#00629b] print:shadow-none print:border-0 print:p-8 print:mx-8 print:max-w-none`}>
      <header className="mb-8 pb-4 print:mb-8">
        <h1 className="text-5xl font-bold print:text-[#00629b]">{resume.basics.name}</h1>
        <h2 className="text-3xl text-gray-500 ">{resume.basics.label}</h2>
